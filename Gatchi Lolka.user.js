...
// @description	  Bla Bla blyat. Prosto Sho ya delay
// @author        mlglolz
// @homepage      https://userstyles.org/styles/185643
// @include       http://lolz.guru/*
// @include       https://lolz.guru/*
// @include       http://*.lolz.guru/*
// @include       https://*.lolz.guru/*
// @run-at        document-start
// @version       0.20200623073503
// ==/UserScript==
(function() {var css = [
	...
	"  {",
	"    background: linear-gradient(to right, rgb(190, 34, 34) 0%, rgb(200, 189, 34) 13%, rgb(202, 205, 29) 27%, rgb(71, 199, 29) 40%, rgb(124, 186, 234) 57%, rgb(102, 116, 193) 76%, rgb(237, 125, 209) 92%) !important;",
	...
	"  {",
	"    box-shadow: 0 2px 18px 2px rgb(237, 125, 177) !important;",
	"  }",
	"",
	"  div.messageMeta.ToggleTriggerAnchor",
	"  {",
	...
	"    box-shadow: 0 0 20px 0 rgb(237, 125, 177)!important;",
	"  }",
	"",
	"  div.bottom",
	"  {",
	"    background: linear-gradient(to right, rgb(190, 34, 34) 0%, rgb(200, 189, 34) 13%, rgb(202, 205, 29) 27%, rgb(71, 199, 29) 40%, rgb(124, 186, 234) 57%, rgb(102, 116, 193) 76%, rgb(237, 125, 209) 92%) !important;",
	"    box-shadow: 0 0 55px 0 rgb(237, 125, 177) !important;",
	"  }",
	"",
	"  div.xenOverlay.memberCard.Checked",
	"  {",
	"    box-shadow: 0 5px 66px 10px rgb(237, 125, 177)!important;",
	"  }",
	"",
	...
	"    border-radius: 15px;",
	"    background: linear-gradient(to right, rgb(190, 34, 34) 0%, rgb(200, 189, 34) 13%, rgb(202, 205, 29) 27%, rgb(71, 199, 29) 40%, rgb(124, 186, 234) 57%, rgb(102, 116, 193) 76%, rgb(237, 125, 209) 92%) !important;",
	"    box-shadow: 0 2px 18px 2px rgb(237, 125, 177);",
	...
	"  {",
	"    background: url(https://pbs.twimg.com/media/Dy4rZArX4AAOgFe.jpg:large) no-repeat;",
	...
	"  {",
	"    background-size: 100%;",
	"    background: url(https://i.imgur.com/I0KcdTl.png) no-repeat;",
	"  }",
	"",
	...
	"  .Menu",
	"  {",
	"    box-shadow: 0 12px 25px rgb(237, 125, 177)!important;",
	"  }",
	"",
	"  li.message",
	"  {",
