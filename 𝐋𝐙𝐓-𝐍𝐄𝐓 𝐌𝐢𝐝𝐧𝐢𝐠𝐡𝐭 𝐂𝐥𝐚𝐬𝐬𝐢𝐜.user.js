// ==UserScript==
// @name          𝐋𝐙𝐓>𝐍𝐄𝐓 𝐌𝐢𝐝𝐧𝐢𝐠𝐡𝐭 𝐂𝐥𝐚𝐬𝐬𝐢𝐜
// @namespace     http://userstyles.org
// @description	  Lolzteam Midnight Theme - лучшая на данный момент тема для нашего любимого форума. Пользуйтесь на здоровье. Обновления выходят каждый день, не забывайте обновлять.
// @author        Anty Day
